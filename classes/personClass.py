import datetime, mySQLFunctions, myGenFunctions
...
class person:
    ...
    def ChildrenNames(self, strFormatType=None):
    ...
    def FormattedName(self, strFormatType=None):
        '''types are Lg, Ng, Lgb, '''
        self.tuple_info = []
        self.tuple_info.append(self.Characteristic('Surname'))
        self.tuple_info.append(self.Characteristic('GivenName'))
        self.tuple_info.append(self.Characteristic('BirthYear'))
        self.tuple_info.append(self.Characteristic('DeathYear'))
        self.tuple_info = tuple(self.tuple_info)
        self.formatted_name = myGenFunctions.getFormattedName(self.tuple_info, strFormatType)
